...
bfrt.nat.pipe.Ingress.send_out.l3_forward_table.add_with_l3_forward(0xC0A80101, 180, 0x012345678901, 0x1070fd190095)
bfrt.nat.pipe.Ingress.send_out.l3_forward_table.add_with_l3_forward(0xC0A80102, 164, 0x012345678901, 0x1070fd2fd851)
bfrt.nat.pipe.Ingress.send_out.l3_forward_table.add_with_l3_forward(0xC0A80203, 148, 0x012345678902, 0x1070fd2fe441)
bfrt.nat.pipe.Ingress.send_out.l3_forward_table.add_with_l3_forward(0xC0A80104, 132, 0x012345678901, 0x1070fd2fd421)
