...
# Since all VIP->DIP mapping happen in switch, the number of server 
# has no impact on performance.

switch_mac = [0x020000000001, 0x020000000001, 0x020000000101, 0x020000000201, 0x020000000101]
#lb_sets = [(0xC0A801FE, [worker_ip[2], worker_ip[4]], 32)]
lb_sets = [(0xC0A801FE, [worker_ip[2]], 32), (0xC0A801FD, [worker_ip[4]], 32)]
